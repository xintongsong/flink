...
public interface ResourceManagerDriver<WorkerType extends ResourceIDRetrievable> {
	 ...
	 */
	void initialize(ResourceEventHandler<WorkerType> resourceEventHandler, Executor mainThreadExecutor) throws Throwable;
	 ...
	 * @throws ResourceManagerException if the application could not be deregistered.
	 */
	 ...
	 * @return Future that wraps worker node of the requested resource, in the deployment specific type.
	 */
