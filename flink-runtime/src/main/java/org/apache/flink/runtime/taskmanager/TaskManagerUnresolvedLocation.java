 ...
 */
public class TaskManagerUnresolvedLocation implements Serializable {
	...
	public TaskManagerUnresolvedLocation(final ResourceID resourceID, final String externalAddress, final int dataPort) {
