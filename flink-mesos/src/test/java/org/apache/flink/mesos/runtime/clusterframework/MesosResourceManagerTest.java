...
public class MesosResourceManagerTest extends TestLogger {
	...
	static class Context implements AutoCloseable {
		...
		Context() throws Exception {
			...
			configuration.setString(TaskManagerOptions.TASK_MANAGER_MEMORY, "1024m");
			ContaineredTaskManagerParameters containeredParams =
				new ContaineredTaskManagerParameters(TaskManagerResource.calculateFromConfiguration(configuration), 4, new HashMap<String, String>());
