...
public class TestingJobMasterGateway implements JobMasterGateway {
	...
	@Nonnull
	private final BiFunction<String, TaskManagerUnresolvedLocation, CompletableFuture<RegistrationResponse>> registerTaskManagerFunction;
	...
	public TestingJobMasterGateway(
			...
			@Nonnull BiFunction<String, TaskManagerUnresolvedLocation, CompletableFuture<RegistrationResponse>> registerTaskManagerFunction,
	...
	@Override
	public CompletableFuture<RegistrationResponse> registerTaskManager(String taskManagerRpcAddress, TaskManagerUnresolvedLocation taskManagerUnresolvedLocation, Time timeout) {
		return registerTaskManagerFunction.apply(taskManagerRpcAddress, taskManagerUnresolvedLocation);
	}
