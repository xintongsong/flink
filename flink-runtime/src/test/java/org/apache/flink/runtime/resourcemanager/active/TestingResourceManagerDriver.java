...
public class TestingResourceManagerDriver implements ResourceManagerDriver<ResourceID> {
	...
	private final BiConsumerWithException<ResourceEventHandler<ResourceID>, Executor, Throwable> initializeConsumer;
	...
	private TestingResourceManagerDriver(
			final BiConsumerWithException<ResourceEventHandler<ResourceID>, Executor, Throwable> initializeConsumer,
	...
	@Override
	public void initialize(ResourceEventHandler<ResourceID> resourceEventHandler, Executor mainThreadExecutor) throws Throwable {
	...
	public static class Builder {
		private BiConsumerWithException<ResourceEventHandler<ResourceID>, Executor, Throwable> initializeConsumer =
				(ignore1, ignore2) -> {};
		...
		public Builder setInitializeConsumer(BiConsumerWithException<ResourceEventHandler<ResourceID>, Executor, Throwable> initializeConsumer) {
			this.initializeConsumer = Preconditions.checkNotNull(initializeConsumer);
			return this;
		}
		...
		public Builder setDeregisterApplicationConsumer(BiConsumerWithException<ApplicationStatus, String, Throwable> deregisterApplicationConsumer) {
			this.deregisterApplicationConsumer = Preconditions.checkNotNull(deregisterApplicationConsumer);
			return this;
		}
