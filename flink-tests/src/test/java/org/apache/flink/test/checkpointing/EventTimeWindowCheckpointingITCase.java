...
public class EventTimeWindowCheckpointingITCase extends TestLogger {
	...
	protected Configuration createClusterConfig() throws IOException {
		...
		config.setString(TaskManagerOptions.TASK_MANAGER_MEMORY_MANAGED, "48m");
		// the default network buffers size (10% of heap max =~ 150MB) seems to much for this test case
		config.setString(TaskManagerOptions.TASK_MANAGER_MEMORY_NETWORK_MAX, String.valueOf(80L << 20)); // 80 MB
