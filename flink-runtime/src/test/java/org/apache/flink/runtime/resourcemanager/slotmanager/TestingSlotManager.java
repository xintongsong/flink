...
public class TestingSlotManager implements SlotManager {
	...
	private final Supplier<Map<WorkerResourceSpec, Integer>> getPendingWorkerNumsSupplier;

	TestingSlotManager(
			Consumer<Boolean> setFailUnfulfillableRequestConsumer,
			Supplier<Map<WorkerResourceSpec, Integer>> getPendingWorkerNumsSupplier) {
	...
	public Map<WorkerResourceSpec, Integer> getPendingWorkerNums() {
		return getPendingWorkerNumsSupplier.get();
	}
