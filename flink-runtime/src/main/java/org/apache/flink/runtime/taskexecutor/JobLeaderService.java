...
public class JobLeaderService {
	...
	private final TaskManagerUnresolvedLocation ownLocation;
	...
	public JobLeaderService(
			TaskManagerUnresolvedLocation location,
	...
	private static final class JobManagerRetryingRegistration
		...
		protected CompletableFuture<RegistrationResponse> invokeRegistration(
				...
				long timeoutMillis) {
			return gateway.registerTaskManager(taskManagerRpcAddress, taskManagerUnresolvedLocation, Time.milliseconds(timeoutMillis));
		}
	}
