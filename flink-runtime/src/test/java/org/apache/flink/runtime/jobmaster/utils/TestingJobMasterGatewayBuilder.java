...
public class TestingJobMasterGatewayBuilder {
	...
	private BiFunction<String, TaskManagerUnresolvedLocation, CompletableFuture<RegistrationResponse>> registerTaskManagerFunction = (ignoredA, ignoredB) -> CompletableFuture.completedFuture(new JMTMRegistrationSuccess(RESOURCE_MANAGER_ID));
	...
	public TestingJobMasterGatewayBuilder setRegisterTaskManagerFunction(BiFunction<String, TaskManagerUnresolvedLocation, CompletableFuture<RegistrationResponse>> registerTaskManagerFunction) {
