...
/**
 * Wrap of {@link ResourceManagerGateway#registerTaskExecutor} parameters.
 */
public class ResourceManagerGatewayRegisterTaskExecutorParams implements Serializable {
	/**
