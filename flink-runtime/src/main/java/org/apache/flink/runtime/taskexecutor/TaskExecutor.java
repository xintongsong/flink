...
public class TaskExecutor extends RpcEndpoint implements TaskExecutorGateway {
	...
	public TaskExecutor(
		...
		this.taskManagerUnresolvedLocation = taskExecutorServices.getTaskManagerUnresolvedLocation();
		...
		final ResourceID resourceId = taskExecutorServices.getTaskManagerUnresolvedLocation().getResourceID();
	...
	private void connectToResourceManager() {
		...
		final TaskExecutorRegistration taskExecutorRegistration = new TaskExecutorRegistration(
			getAddress(),
			getResourceID(),
			taskManagerUnresolvedLocation.getDataPort(),
			hardwareDescription,
	...
	public ResourceID getResourceID() {
		return taskManagerUnresolvedLocation.getResourceID();
	}
