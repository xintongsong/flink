...
public class WorkerSpecContainerResourceAdapterTest extends TestLogger {
	...
	public void testIgnoreVcores() {
		...
		assertThat(adapter.getContainerResource(workerSpec1).get(), is(containerResource1));
		assertThat(adapter.getContainerResource(workerSpec2).get(), is(containerResource2));
		assertThat(adapter.getContainerResource(workerSpec3).get(), is(containerResource1));
		assertThat(adapter.getContainerResource(workerSpec4).get(), is(containerResource3));
	...
	public void testMaxLimit() {
		...
		assertFalse(adapter.getContainerResource(workerSpec1).isPresent());
		assertFalse(adapter.getContainerResource(workerSpec2).isPresent());
	}
