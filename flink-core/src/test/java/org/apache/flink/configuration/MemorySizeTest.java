...
public class MemorySizeTest {
	...
	public void testToHumanReadableString() {
		...
		assertThat(new MemorySize(1025L).toHumanReadableString(), is("1.001kb (1025)"));
		assertThat(new MemorySize(1536L).toHumanReadableString(), is("1.500kb (1536)"));
		assertThat(new MemorySize(1_000_000L).toHumanReadableString(), is("976.563kb (1000000)"));
		assertThat(new MemorySize(1_000_000_000L).toHumanReadableString(), is("953.674mb (1000000000)"));
		assertThat(new MemorySize(1_000_000_000_000L).toHumanReadableString(), is("931.323gb (1000000000000)"));
		assertThat(new MemorySize(1_000_000_000_000_000L).toHumanReadableString(), is("909.495tb (1000000000000000)"));
	}
}
