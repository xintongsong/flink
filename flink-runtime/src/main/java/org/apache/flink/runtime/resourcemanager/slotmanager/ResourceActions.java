...
public interface ResourceActions {
	...
	/**
	 * Requests to allocate a resource with the given {@link WorkerRequest}.
	 *
	 * @param workerRequest for the to be allocated resource
	 * @return whether the resource can be allocated
	 */
	boolean allocateResource(WorkerRequest workerRequest);
