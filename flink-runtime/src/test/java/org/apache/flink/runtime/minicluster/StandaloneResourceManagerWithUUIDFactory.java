...
public enum StandaloneResourceManagerWithUUIDFactory implements ResourceManagerFactory<ResourceID> {
	...
	public ResourceManager<ResourceID> createResourceManager(
		...
		final Time standaloneSlotResourcesRegistrationTimeout = ConfigurationUtils.getStandaloneSlotResourcesRegistrationTimeout(configuration);
		...
		return new StandaloneResourceManager(
			...
			standaloneSlotResourcesRegistrationTimeout);
	}
}
