...
public class TaskManagerOptions {
	 ...
	 * We do not expose this option to the users, and only use it internally for the moment.
	 */
	...
	public static final ConfigOption<Double> CPU_CORES =
		key("taskmanager.cpu.cores")
			...
			.withDescription("CPU cores for the TaskExecutors. In case of Yarn setups, this value will be rounded to "
				...
				+ "and 1 / '" + DEFAULT_SLOT_FRACTION.key() + "' will be used for standalone setups (approximate number "
				+ "of slots).");
